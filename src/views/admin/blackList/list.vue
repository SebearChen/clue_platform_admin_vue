<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column fixed label="手机号" align="left">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.pageSize" @pagination="getBlacklistAll" />
  </div>
</template>

<script>
import { getBlacklistAll, delBlacklist} from '@/api/blacklist'
...
export default {
  ...
  // },
  methods: {
    async getBlacklistAll() {
      this.listLoading = true
      const response = await getBlacklistAll(this.listQuery)
