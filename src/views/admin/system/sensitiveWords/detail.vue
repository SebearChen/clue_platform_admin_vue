    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        <div class="postInfo-container">
          <el-row>
            <el-col :span="12">
              <el-form-item prop="names" class="form-items" required>
                <MDinput v-model="postForm.names" :maxlength="80" name="names" :disabled="isReadonly"> 敏感词 (每个敏感词以 英文逗号 隔开) </MDinput>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
...
import { getKeywordsList, createKeywords } from '@/api/system/sensitiveWords'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loading: false,
      rules: {
        names: [{ validator: validateRequire }]
      },
    }
  },
  computed: {
    ...
    onSave() {
      this.$confirm(`是否确认保存？`, '警告', {
        ...
        this.$refs.postForm.validate(valid => {
          ...
          this.loading = true
          var names = this.postForm.names.split(",")
          createKeywords(names).then(res => {
          ...
          this.readonly = false
          // const saveFunc = this.isNew ? createKeywords : ''
