<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-row>
        ...
        <el-col :span="6" align="right" class="small-padding">
          <router-link :to="'/system/sensitiveWords/create'">
    ...
    <el-table
      ...
      <el-table-column fixed label="关键词" align="left">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.pageSize" @pagination="getKeywordsList" />
  </div>
</template>

<script>
import { getKeywordsList, delKeywordsList } from '@/api/system/sensitiveWords'
...
export default {
  ...
  methods: {
    async getKeywordsList() {
      ...
      const response = await getKeywordsList(this.listQuery)
