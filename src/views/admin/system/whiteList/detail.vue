    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        <div class="postInfo-container">
          <el-row>
            <el-col :span="12">
              <el-form-item prop="ip" class="form-items" required>
                <MDinput v-model="postForm.ip" :maxlength="200" name="ip" :disabled="isReadonly"> ip (一次只能添加一个) </MDinput>
              </el-form-item>
              <el-form-item prop="remark" class="form-items">
                <MDinput v-model="postForm.remark" :maxlength="200" name="remark" :disabled="isReadonly"> 备注</MDinput>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
...
import { createWhitelist } from '@/api/system/whitelist'
    ...
    onSave() {
      this.$confirm(`是否确认保存？`, '警告', {
        ...
        this.$refs.postForm.validate(valid => {
          ...
          this.loading = true
          // var ip = this.postForm.ip
          createWhitelist(this.postForm).then(res => {
